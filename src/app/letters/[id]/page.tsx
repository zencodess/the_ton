    ...
    return (
        <div style={{
            ...
            <div className="card animate-fade-in" style={{
                ...
                <div style={{ marginTop: 'var(--space-2xl)', paddingTop: 'var(--space-md)', borderTop: '1px solid var(--border-subtle)', textAlign: 'center', color: 'var(--ink-light)', fontSize: '0.875rem' }}>
                    <p><em>✧ This society paper was generated by Lady Whistledown AI. ✧</em></p>
                </div>
            </div>
        </div>
    );
